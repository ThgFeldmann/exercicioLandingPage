...
const dataDoEvento = new Date("feb 7, 2025 15:00:00");
...
const contaAsHoras = setInterval(function() {
    ...
    document.getElementById('contadorFuturo').innerHTML = `${diasAteOEvento}d ${horasAteOEvento}h ${minutosAteOEvento}m ${segundosAteOEvento}s`
